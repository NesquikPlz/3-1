...
import DB.MovieDB;
import DB.MovieDB.MovieClass;

public class MovieGui extends JPanel {		//영화검색부분을 담당하는 클래스
	...
	private MovieDB rdb;					//DB랑 연결하는 객체
	...
	public MovieGui(JFrame j) {					//mainGui에서 부르는 함수; 프레임에 movie panel을 넣는 역할
